...
//            TestLog.appendToFile(filename, data);
            ...
            String filename = "CollisionTest-"+numBits+"Bit-"+ROUNDS_LARGE+"Rounds.txt";
            String data = String.format("Beginning %d Round Collision Test\n", ROUNDS_LARGE);
            TestLog.overrideFile(filename, data);
            ...
            int expectedNumHashes = (int)Math.pow(2, ((double) numBits/2));
            data = String.format("\nExpected avg number of hashes: %d\nActual avg number of hashes: %.2f",
                    expectedNumHashes, (hashSum/ROUNDS_LARGE));
            TestLog.appendToFile(filename, data);
        }
